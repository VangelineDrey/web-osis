      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
            <h2>Get to know more about the creators</h2>
          </div>
        ...
        <div id="portfolio-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="https://www.instagram.com/rf_0654/?hl=id" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/kelompok/img/reynald.png">
            </a>
          </div>
          <div class="item photography col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="https://www.instagram.com/tendasuyo/?hl=id" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/kelompok/img/ricatt.png">
            </a>
          </div>
        </div>
      </div>
